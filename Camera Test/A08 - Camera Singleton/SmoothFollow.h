...
public:
	...
	void Update(float fDeltaTime)
	{
		...
		vector3 v3NewForward = glm::lerp(v3CurrentForward, v3DesiredForward, m_fRotationDamping * fDeltaTime);	// Lerps the forward direction to the desired forward
