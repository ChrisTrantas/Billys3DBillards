...
char* Shader::loadTextFile(const char* file)
{
    //Open
...
GLuint Shader::loadShader(const char* file, GLenum shaderType)
{
    //loadTextFile
...
GLuint Shader::loadShaderProgram(const char* vertexFile, const char* fragmentFile)
{
